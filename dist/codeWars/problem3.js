...
function narcissistic(value) {
    ...
    const isNarcissistic = valueArr === null || valueArr === void 0 ? void 0 : valueArr.map(n => Math.pow(Number(n), valueArr.length)).reduce((a, total) => { return a + total; }, 0);
...
function sumUpNumbers(arr) {
    // your code here
    const usFormatte = arr === null || arr === void 0 ? void 0 : arr.map(n => {
    ...
    return usFormatte === null || usFormatte === void 0 ? void 0 : usFormatte.reduce((a, c) => a + c, 0).toLocaleString('en-US');
}
